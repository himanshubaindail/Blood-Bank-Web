...
public class Correction extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String sql="UPDATE donor SET contact=?, address=?, photo=? WHERE id="+session.getAttribute("did")+" ";
            ...
            String sql="UPDATE reciever SET contact=?, address=?, photo=? WHERE id="+session.getAttribute("rid")+" ";
            Connection con = DriverManager.getConnection(host,uName,uPass); 
            PreparedStatement st = con.prepareStatement(sql);
            st.setLong(1, contact);
            st.setString(2, address);
