    ...
    <body style="margin: 0px;">
        ...
        <div style="background: url(bloodcell.jpg) no-repeat ; height: 560px; border: 2px solid; background-size: cover;"><br>
            <fieldset style="width: 0px; padding: 20px 20px; margin: auto; background-color: #eaeaea;">
                <legend style="font-size: larger; background: #8b8b8b; color: whitesmoke; border-radius: 10px;">&nbsp;Reciever Registration&nbsp;</legend>
                <form action="Reciever" method="post" name="form" enctype="multipart/form-data">
